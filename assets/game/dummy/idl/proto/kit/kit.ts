...
@protobuf.Type.d("dummy_kitproto_LogOption")
export class LogOption extends protobuf.Message<ILogOption> {
    ...
    @protobuf.Field.d(1, "dummy_kitproto_ErrorCodeLogOption", "repeated")
...
@protobuf.Type.d("dummy_kitproto_ErrorCodeLogOption")
