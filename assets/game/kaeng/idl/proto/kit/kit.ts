...
@protobuf.Type.d("kaeng_kitproto_LogOption")
export class LogOption extends protobuf.Message<ILogOption> {
    ...
    @protobuf.Field.d(1, "kaeng_kitproto_ErrorCodeLogOption", "repeated")
...
@protobuf.Type.d("kaeng_kitproto_ErrorCodeLogOption")
